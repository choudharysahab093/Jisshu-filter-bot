...
BOT_TOKEN = environ.get('BOT_TOKEN', '7745762451:AAGE37KmSTK-SkTCJc-Dhoc-BxIwnMvpSWU')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7977862043').split()]
USERNAME = environ.get('USERNAME', "https://t.me/") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002281424624'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/moviegroup255')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002087242344').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'harikushal')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002333741358'))
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/SC_TEAM_MOVIE') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
